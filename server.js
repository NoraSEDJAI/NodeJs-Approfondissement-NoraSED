...
app.use("/api/articles/byuserid/:userId", articlesController.getArticlesByUserId); //Route public pour récupérer les articles d'un utilisateur sans authentification.
